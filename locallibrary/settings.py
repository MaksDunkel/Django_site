...
# STATIC_URL = '/static/' - ниже еще раз добавили при настройке для ХЕРОКУ

# Redirect to home URL after login (Default redirects to /accounts/profile/)
LOGIN_REDIRECT_URL = '/'

# Heroku: Update database configuration from $DATABASE_URL.----HEROKUUU----
...
# Simplified static file serving. При желании вы можете уменьшить размер статических файлов при их обслуживании (это более эффективно) для этого команда ниже
